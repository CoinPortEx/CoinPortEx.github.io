...
- **Contract Address**: Native to Cardano. Add to wallets like Daedalus or Yoroi.
...
- **Chang Hard Fork**: Completed the Voltaire transition, enabling community governance and on-chain treasury voting.
- **Hydra Scaling**: A Layer 2 head protocol that significantly increases throughput with sub-second finality.
- **ETF Inclusion Proposals**: Cardano has been proposed for inclusion in multi-asset crypto ETFs, signalling growing institutional interest.
