...
In line with Austrac AML/CTF laws, deposits are only accepted from a bank account that is in the same name as the account you have verified with CoinPort Pty Ltd.
This service is provided by CoinPort Pty Ltd in accordance with our Terms and Conditions and Privacy Policy.
